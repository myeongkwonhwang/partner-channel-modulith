...
interface ChannelProcessedEventJpaRepository extends JpaRepository<ChannelProcessedEventJpaEntity, ProcessedEventId> {
    ...
    @Modifying
    @Query(value = """
            INSERT INTO channel_schema.processed_event (consumer_name, event_id, processed_at)
