...
interface CoreProcessedEventJpaRepository extends JpaRepository<CoreProcessedEventJpaEntity, ProcessedEventId> {
    ...
    @Modifying
    @Query(value = """
            INSERT INTO core_schema.processed_event (consumer_name, event_id, processed_at)
